...
def _build_pokemons():
    ...
    def try_image_names_form(path, info, extension):
    ...
    def csv_record_to_objects(info):
        poke_sprites = "pokemon/"
        sprites = {
            "front_default": try_image_names_form(poke_sprites, info, "png"),
            "front_shiny": try_image_names_form(poke_sprites + "shiny/", info, "png"),
            "back_default": try_image_names_form(poke_sprites + "back/", info, "png"),
            "back_shiny": try_image_names_form(poke_sprites + "back/shiny/", info, "png"),
            "front_female": try_image_names_form(poke_sprites + "female/", info, "png"),
            "front_shiny_female": try_image_names_form(poke_sprites + "shiny/female/", info, "png"),
            "back_female": try_image_names_form(poke_sprites + "back/female/", info, "png"),
            "back_shiny_female": try_image_names_form(poke_sprites + "back/shiny/female/", info, "png"),
            "versions": {
                "generation-viii": {
                    "brilliant-diamond-shining-pearl": {
                        "front_default": try_image_names_form(
                            poke_sprites + "versions/generation-viii/brilliant-diamond-shining-pearl/",
                            info,
                            "png",
                        ),
                        "front_female": try_image_names_form(
