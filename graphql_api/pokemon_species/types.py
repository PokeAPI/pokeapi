...
class PokemonSpecies(g.ObjectType):
    ...
    # color = g.Field(
    #     g.lazy_import("graphql_api.pokemon_color.types.PokemonColor"),
    #     description="The color of this Pokémon for Pokédex search.",
    #     resolver=load("pokemoncolor", using="pokemon_color_id"),
    # )
    # egg_groups = g.List(
    #     g.lazy_import("graphql_api.egg_group.types.EggGroup"),
    ...
    #     g.lazy_import("graphql_api.evolution_chain.types.EvolutionChain"),
    ...
    growth_rate_id = None
    # growth_rate = g.Field(
    #     g.lazy_import("graphql_api.growth_rate.types.GrowthRate"),
    ...
    # habitat = g.Field(
    #     g.lazy_import("graphql_api.pokemon_habitat.types.PokemonHabitat"),
    ...
    # shape = g.Field(
    #     g.lazy_import("graphql_api.pokemon_shape.types.PokemonShape"),
    ...
    varieties = g.List(
        g.lazy_import("graphql_api.pokemon.types.Pokemon"),
...
class PokemonSpeciesPalParkEncounter(g.ObjectType):
    ...
    #     g.lazy_import("graphql_api.pal_park_area.types.PalParkArea"),
