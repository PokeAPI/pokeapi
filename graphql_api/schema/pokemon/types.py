...
class Pokemon(g.ObjectType):
    ...
    species = g.Field(
        g.lazy_import("graphql_api.schema.pokemon_species.types.PokemonSpecies"),
...
class PokemonHeldItem(g.ObjectType):
    ...
    pokemon_id = None
    # item = g.Field(
    #     lazy_import("graphql_api.schema.item_interface.types.ItemInterface"),
...
class PokemonMoveVersion(g.ObjectType):
    ...
    move_learn_method = g.Field(
        g.lazy_import("graphql_api.schema.move_learn_method.types.MoveLearnMethod"),
