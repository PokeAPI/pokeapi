...
class APIData:
    ...
    def setup_language_name_data(self, language, name="lang nm"):
        ...
        local_language = self.setup_language_data(name="lang for " + name)
    ...
    def setup_region_name_data(self, region, name="reg nm"):
        ...
        language = self.setup_language_data(name="lang for " + name)
    ...
    def setup_generation_data(self, region=None, name="gen"):
        ...
        region = region or self.setup_region_data(name="reg for " + name)
    ...
    def setup_version_group_data(self, name="ver grp", generation=None):
        ...
        generation = generation or self.setup_generation_data(name="gen for " + name)
    ...
    def setup_ability_effect_text_data(
        self, ability, short_effect="ablty shrt efct", effect="ablty efct"
    ):

        language = self.setup_language_data(name="lang for " + effect)
    ...
    def setup_ability_change_data(self, ability):
        ...
        version_group = self.setup_version_group_data(name="ver grp for ablty chng")
    ...
    def setup_ability_change_effect_text_data(
        self, ability_change, effect="ablty change efct"
    ):
    ...
    def setup_ability_flavor_text_data(self, ability, flavor_text="ablty flvr txt"):
        ...
        version_group = self.setup_version_group_data(name="ver grp for " + flavor_text)

        language = self.setup_language_data(name="lang for " + flavor_text)
    ...
    def setup_item_attribute_description_data(
        self, item_attribute, description="itm attr desc"
    ):

        language = self.setup_language_data(name="lang for " + description)
    ...
    def setup_item_fling_effect_effect_text_data(
        self, item_fling_effect, effect="itm flng efct efct txt"
    ):
    ...
    def setup_item_sprites_data(self, item, default=True):
        ...
        sprites = {"default": sprite_path % item.id if default else None}
    ...
    def setup_item_effect_text_data(
        self, item, short_effect="ablty shrt efct", effect="ablty efct"
    ):
    ...
    def setup_item_game_index_data(self, item, game_index=0):
        ...
        generation = self.setup_generation_data(name="gen for itm gm indx")
    ...
    def setup_contest_effect_flavor_text_data(
        self, contest_effect, flavor_text="cntst efct flvr txt"
    ):
    ...
    def setup_contest_effect_effect_text_data(
        self, contest_effect, effect="cntst efct efct txt"
    ):
    ...
    def setup_super_contest_effect_flavor_text_data(
        self, super_contest_effect, flavor_text="spr cntst efct flvr txt"
    ):
    ...
    def setup_berry_data(
        ...
        item = item or self.setup_item_data(name="itm for " + name)
    ...
    def setup_growth_rate_description_data(
        self, growth_rate, description="grth rt desc"
    ):
    ...
    def setup_location_data(self, region=None, name="lctn"):
        ...
        region = region or self.setup_region_data(name="rgn for " + name)
    ...
    def setup_location_area_data(self, location=None, name="lctn area", game_index=0):
        ...
        location = location or self.setup_location_data(name="lctn for " + name)
    ...
    def setup_type_data(self, name="tp", move_damage_class=None, generation=None):
        ...
        generation = generation or self.setup_generation_data(name="rgn for " + name)
    ...
    def setup_type_game_index_data(self, type, game_index=0):
        ...
        generation = self.setup_generation_data(name="gen for tp gm indx")
    ...
    def setup_move_category_description_data(
        self, move_category, description="mv ctgry desc"
    ):
    ...
    @classmethod
    def setup_move_damage_class_name_data(
        self, move_damage_class, name="mv dmg cls nm"
    ):
    ...
    def setup_move_damage_class_description_data(
        self, move_damage_class, description="mv dmg cls desc"
    ):
    ...
    def setup_move_learn_method_name_data(
        self, move_learn_method, name="mv lrn mthd nm"
    ):
    ...
    def setup_move_learn_method_description_data(
        self, move_learn_method, description="mv lrn mthd desc"
    ):
    ...
    def setup_move_target_description_data(
        self, move_target, description="mv trgt desc"
    ):
    ...
    def setup_version_group_move_learn_method_data(
        self, version_group=None, move_learn_method=None
    ):
    ...
    def setup_move_data(
        ...
        super_contest_effect = (
            super_contest_effect or self.setup_super_contest_effect_data()
        )

        generation = generation or self.setup_generation_data(name="gen for " + name)

        type = type or self.setup_type_data(name="tp for " + name)
    ...
    def setup_move_effect_change_data(self, move_effect=None):
        ...
        version_group = self.setup_version_group_data(name="ver grp for mv chng")
    ...
    def setup_move_effect_change_effect_text_data(
        self, move_effect_change=None, effect="mv efct chng efct txt"
    ):
    ...
    def setup_move_stat_change_data(self, move, stat=None, change=1):
        ...
        stat = stat or self.setup_stat_data(name="stt for mv")
    ...
    def setup_characteristic_data(self, gene_mod_5=0, stat=None):
        ...
        stat = stat or self.setup_stat_data(name="stt for char")
    ...
    def setup_characteristic_description_data(
        self, characteristic, description="char desc"
    ):
    ...
    def setup_nature_pokeathlon_stat_data(
        self, nature=None, pokeathlon_stat=None, max_change=1
    ):
    ...
    def setup_pokemon_shape_name_data(
        self, pokemon_shape, name="pkm shp nm", awesome_name="pkm shp awsm nm"
    ):
    ...
    def setup_pokemon_species_form_description_data(
        self, pokemon_species=None, description="pkm spcs frm dscr"
    ):
    ...
    def setup_pokemon_species_flavor_text_data(
        self, pokemon_species, flavor_text="pkmn spcs flvr txt"
    ):

        version = self.setup_version_data(name="ver for " + flavor_text)
    ...
    def setup_pokemon_species_name_data(
        self, pokemon_species, name="pkmn spcs nm", genus="pkmn spcs gns"
    ):
    ...
    def setup_pokemon_game_index_data(self, pokemon, game_index=0):
        ...
        version = self.setup_version_data(name="ver for pkmn gm indx")
    ...
    def setup_pokemon_form_data(
        ...
        version_group = self.setup_version_group_data(name="ver grp for " + name)
    ...
    @classmethod
    def setup_pokemon_ability_data(
        self, pokemon, ability=None, is_hidden=False, slot=1
    ):
    ...
    def setup_pokemon_stat_data(self, pokemon, base_stat=10, effort=10):
        ...
        stat = self.setup_stat_data(name="stt for pkmn")
    ...
    def setup_pokemon_type_data(self, pokemon, type=None, slot=1):
        ...
        type = type or self.setup_type_data(name="tp for pkmn")
    ...
    def setup_pokemon_item_data(self, pokemon=None, item=None, version=None, rarity=50):
        ...
        item = item or self.setup_item_data(name="itm for pkmn")

        pokemon = pokemon or self.setup_pokemon_data(name="pkmn for pkmn")

        version = version or self.setup_version_data(name="ver grp for pkmn itm")
    ...
    @classmethod
    def setup_evolution_trigger_name_data(
        self, evolution_trigger, name="evltn trgr nm"
    ):
    ...
    def setup_encounter_condition_name_data(
        self, encounter_condition, name="encntr cndtn nm"
    ):
    ...
    def setup_encounter_condition_value_data(
        self, encounter_condition, name="encntr cndtn vlu", is_default=False
    ):
    ...
    def setup_encounter_condition_value_name_data(
        self, encounter_condition_value, name="encntr cndtn vlu nm"
    ):
    ...
    def setup_encounter_condition_value_map_data(
        self, encounter, encounter_condition_value
    ):
    ...
    def setup_encounter_slot_data(self, encounter_method=None, slot=0, rarity=0):
        ...
        version_group = self.setup_version_group_data(name="ver grp for encntr slt")
    ...
    def setup_location_area_encounter_rate_data(
        self, location_area, encounter_method, rate=0
    ):

        version = self.setup_version_data(name="ver for lctn area")
    ...
    def setup_encounter_data(
        ...
        pokemon = pokemon or self.setup_pokemon_data(name="pkmn for encntr")

        version = version or self.setup_version_data(name="ver for encntr")
    ...
    def setup_pal_park_data(
        self, pokemon_species=None, pal_park_area=None, base_score=10, rate=10
    ):
