...
class APIData():
    ...
    def setup_region_name_data(cls, region, name='reg nm'):
        ...
        language = cls.setup_language_data(
            name='lang for ' + name)
    ...
    def setup_generation_data(cls, region=None, name='gen'):
        ...
        region = region or cls.setup_region_data(
            name='reg for ' + name)
    ...
    def setup_version_group_data(cls, name='ver grp', generation=None):
        ...
        generation = generation or cls.setup_generation_data(
            name='gen for ' + name)
    ...
    def setup_ability_change_data(cls, ability):
        ...
        version_group = cls.setup_version_group_data(
    ...
    @classmethod
    def setup_item_fling_effect_effect_text_data(cls, item_fling_effect,
    ...
    @classmethod
    def setup_item_data(cls, item_category=None, item_fling_effect=None,
    ...
    @classmethod
    def setup_item_effect_text_data(cls, item,
                                    short_effect='ablty shrt efct', effect='ablty efct'):
    ...
    def setup_item_game_index_data(cls, item, game_index=0):
        ...
        generation = cls.setup_generation_data(
    ...
    @classmethod
    def setup_contest_effect_flavor_text_data(cls,
    ...
    @classmethod
    def setup_super_contest_effect_flavor_text_data(cls, super_contest_effect,
    ...
    @classmethod
    def setup_berry_data(cls, berry_firmness=None, item=None, natural_gift_type=None,
    ...
    def setup_location_area_data(cls, location=None, name='lctn area', game_index=0):
        ...
        location = location or cls.setup_location_data(
            name='lctn for ' + name)
    ...
    @classmethod
    def setup_move_effect_effect_text_data(cls, move_effect, effect='mv efct efct txt',
    ...
    @classmethod
    def setup_move_damage_class_description_data(cls, move_damage_class,
    ...
    @classmethod
    def setup_move_learn_method_description_data(cls, move_learn_method,
    ...
    @classmethod
    def setup_version_group_move_learn_method_data(cls, version_group=None,
    ...
    @classmethod
    def setup_move_data(cls, contest_type=None, contest_effect=None, super_contest_effect=None,
    ...
    @classmethod
    def setup_move_meta_data(cls, move, move_ailment=None, move_category=None,
    ...
    @classmethod
    def setup_move_change_data(cls, move=None, type=None, move_effect=None,
    ...
    @classmethod
    def setup_move_effect_change_effect_text_data(cls, move_effect_change=None,
    ...
    def setup_move_stat_change_data(cls, move, stat=None, change=1):
        ...
        stat = stat or cls.setup_stat_data(
            name='stt for mv')
    ...
    # Nature Data
    @classmethod
    def setup_nature_data(cls, decreased_stat=None, increased_stat=None,
    ...
    @classmethod
    def setup_nature_battle_style_preference_data(cls, nature=None, move_battle_style=None,
    ...
    @classmethod
    def setup_pokemon_shape_name_data(cls, pokemon_shape, name='pkm shp nm',
    ...
    @classmethod
    def setup_pokemon_species_form_description_data(cls, pokemon_species=None,
    ...
    @classmethod
    def setup_pokemon_species_flavor_text_data(cls, pokemon_species,
                                               flavor_text='pkmn spcs flvr txt'):

        version = cls.setup_version_data(
    ...
    @classmethod
    def setup_pokemon_species_data(cls, generation=None, evolves_from_species=None,
    ...
    @classmethod
    def setup_pokemon_species_name_data(cls, pokemon_species, name='pkmn spcs nm',
                                        genus='pkmn spcs gns'):
    ...
    @classmethod
    def setup_pokemon_data(cls, pokemon_species=None, name='pkmn',
    ...
    @classmethod
    def setup_pokemon_form_data(cls, pokemon, name='pkmn nrml frm',
    ...
    def setup_pokemon_item_data(cls, pokemon=None, item=None, version=None, rarity=50):
        ...
        version = version or cls.setup_version_data(
    ...
    def setup_pokemon_sprites_data(
            cls, pokemon, front_default=True,
    ...
    @classmethod
    def setup_pokemon_evolution_data(cls, evolved_species=None, evolution_trigger=None,
    ...
    @classmethod
    def setup_encounter_condition_value_data(cls, encounter_condition,
    ...
    @classmethod
    def setup_encounter_condition_value_name_data(cls, encounter_condition_value,
    ...
    @classmethod
    def setup_encounter_data(cls, location_area=None, encounter_slot=None,
